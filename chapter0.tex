...
Pointer Generator networkökről, a többi lehet a tavalyi ACLről. De ami még
...
fel nem merül, hogy real-world alkalmazásokban használjuk őket}
...
\section{Evaluation}
\rg{mielőtt a metrikákról írnál, kell egy kis bevezető, amiből kiderül, hogy
...
tökéletlen proxy, hiszen egy rendszer írhatna egy szuperjó, de az emberétől jól
eltérő summaryt.}
...
explicit azt méri, amit szeretnénk (ld. az előző kommentemet), de legalább
...
van értelme rendszereket, ha ugyanolyan hosszú outputokat kértünk tőlük, mivel
...
method, hanem arra egy módszer, hogy ha van human summarym, akkor felülről
becsüljem az extractive módszerrel elérhető ROUGE scoret}
...
\rg{és hogy egy konkrét adaton (CNN-DM) mi ez a felső becslés, az majd a
